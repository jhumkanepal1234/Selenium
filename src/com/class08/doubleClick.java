...
//		driver.close();
		...
		driver.findElement(By.xpath("//input[@placeholder='Username']")).sendKeys("Asmit");
		Actions action = new Actions(driver);
		action.doubleClick(driver.findElement(By.xpath("//input[@placeholder='Username']"))).perform();
